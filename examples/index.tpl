...
<html lang="en">
  ...
  <body>
    <script src="//118.178.125.132:8182/common/lib/vendor.min.js"></script>
    <script src="//118.178.125.132:8182/common/xcbase/xcedu-share.js"></script>
    <script src="//118.178.125.132:8182/common/xcbase/xcedu-components.js"></script>
    <script>
      if (!window.Promise) {
